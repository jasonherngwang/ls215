...
Problem
------------------------------------------
Write a function to check if a number (as a string) is valid per the Luhn 
formula.
...
Luhn Formula
1. Double every digit. If even number of digits, start from index 0. If odd, 
start from index 1.
  1a. If digits doubled >10, subtract 9 from it
2. Sum digits; this is the checksum
3. If last digit of checksum is 10 (checksum % 10 === 0), number is valid. Else, 
invalid.
